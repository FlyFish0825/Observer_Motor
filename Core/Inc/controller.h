...
#define FOC_ID_PI_KI_DEFAULT 1300.0f
#define FOC_ID_PI_OUTPUT_MIN_DEFAULT (-7.0f)
#define FOC_ID_PI_OUTPUT_MAX_DEFAULT   7.0f


#define FOC_IQ_PI_KP_DEFAULT 1.0f
#define FOC_IQ_PI_KI_DEFAULT 1300.0f
#define FOC_IQ_PI_OUTPUT_MIN_DEFAULT (-7.0f)
#define FOC_IQ_PI_OUTPUT_MAX_DEFAULT   7.0f
